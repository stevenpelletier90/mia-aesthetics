					...
					if ( $mia_banner_image ) :
						...
						<div class="special-hero-image">
							<img src="<?php echo esc_url( $mia_banner_image['url'] ); ?>" 
								srcset="<?php echo esc_attr( $mia_banner_image['sizes']['medium'] ); ?> 300w,
										<?php echo esc_attr( $mia_banner_image['sizes']['large'] ); ?> 1024w,
										<?php echo esc_url( $mia_banner_image['url'] ); ?> 
										<?php echo esc_attr( $mia_banner_image['width'] ); ?>w"
