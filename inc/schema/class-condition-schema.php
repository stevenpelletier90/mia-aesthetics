...
class Condition_Schema {
	 ...
	 */
	private function get_featured_video( $condition_id ): ?array {
		$video_details = get_field( 'video_details', $condition_id );
		...
		return array(
			'@type'        => 'VideoObject',
			'@id'          => get_permalink( $condition_id ) . '#video',
			'name'         => $video_title,
			'description'  => $video_description,
			'url'          => 'https://www.youtube.com/watch?v=' . $video_id,
			'embedUrl'     => 'https://www.youtube.com/embed/' . $video_id,
			'thumbnailUrl' => $thumbnail_url,
			'uploadDate'   => get_the_date( 'c', $condition_id ),
			'publisher'    => array(
				'@type' => 'Organization',
				'name'  => 'Mia Aesthetics',
				'url'   => home_url(),
