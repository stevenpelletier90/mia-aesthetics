...
function mia_get_template_mappings(): array {
	return array(
		...
		'page-hero-canvas'            => array(
			'css' => 'page-hero-canvas.css',
			'js'  => 'page-hero-canvas.js',
		),
		'page-hero-canvas-no-bc'      => array(
			'css' => 'page-hero-canvas-no-bc.css',
			'js'  => 'page-hero-canvas-no-bc.js',
		),
		'page-no-bc'                  => array(
			'css' => 'page-no-bc.css',
			'js'  => 'page-no-bc.js',
		...
		'page-before-after-by-doctor' => array(
			'css' => 'page-before-after-by-doctor.css',
			'js'  => 'page-before-after-by-doctor.js',
		),
		'page-case-category'          => array(
			'css' => 'page-case-category.css',
			'js'  => 'page-case-category.js',
		),
		'page-treatment-layout'       => array(
			'css' => 'page-treatment-layout.css',
			'js'  => 'page-treatment-layout.js',
		),
		'page-condition-layout'       => array(
			'css' => 'page-condition-layout.css',
			'js'  => 'page-condition-layout.js',
		),
		'page-careers'                => array(
			'css' => 'page-careers.css',
			'js'  => 'page-careers.js',
		),
		'page-careers-locations'      => array(
			'css' => 'careers-locations.css',
			'js'  => 'careers-locations.js',
		),
		'page-procedures-listing'     => array(
			'css' => 'page-procedures-listing.css',
			'js'  => 'page-procedures-listing.js',
		),
		'page-procedures-manual'      => array(
			'css' => 'page-procedures-manual.css',
		...
		'single-location'             => array(
			'css' => 'single-location.css',
			'js'  => 'single-location.js',
		),
		'single-surgeon'              => array(
			'css' => 'single-surgeon.css',
			'js'  => 'single-surgeon.js',
		),
		'single-special'              => array(
			'css' => 'single-special.css',
		...
		'archive-condition'           => array(
			'css' => 'archive-condition.css',
			'js'  => 'archive-condition.js',
		),
		...
		'archive-location'            => array(
			'css' => 'archive-location.css',
			'js'  => 'archive-location.js',
		),
		'archive-non-surgical'        => array(
			'css' => 'archive-non-surgical.css',
			'js'  => 'archive-non-surgical.js',
		),
		'archive-procedure'           => array(
			'css' => 'archive-procedure.css',
			'js'  => 'archive-procedure.js',
		),
		'archive-special'             => array(
			'css' => 'archive-special.css',
			'js'  => 'archive-special.js',
		),
		'archive-surgeon'             => array(
			'css' => 'archive-surgeon.css',
