...
function mia_get_template_mappings() {
    return [
        ...
        'page-careers-locations'      => ['css' => 'careers-locations.css',          'js' => 'careers-locations.js'],
...
function mia_enqueue_assets() {
    ...
    mia_register_asset( 'style', 'mia-location-search', '/css/location-search.css', [ 'mia-base' ] );
    mia_register_asset( 'script', 'mia-location-search', '/js/location-search.js', [] );
    mia_register_asset( 'style', 'mia-location-search-careers', '/css/location-search-careers.css', [ 'mia-base' ] );
    mia_register_asset( 'script', 'mia-location-search-careers', '/js/location-search-careers.js', [] );
