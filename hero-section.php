...
<section class="hero-section">
	...
	<div class="hero-sidebar">
		...
		<div class="hero-box-overlay">
			...
			<a href="<?php echo esc_url( home_url( '/before-after/' ) ); ?>" class="mia-button" data-variant="gold-border-dark">
		...
		<div class="hero-box-overlay">
			...
			<a href="<?php echo esc_url( home_url( '/financing/' ) ); ?>" class="mia-button" data-variant="gold-border-dark">
