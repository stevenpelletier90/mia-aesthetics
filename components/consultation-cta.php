...
<div id="consultationCta" class="consultation-cta-container d-flex d-sm-none justify-content-center align-items-center position-fixed bottom-0 start-0 w-100 p-3">
	<a href="<?php echo esc_url( home_url( '/free-plastic-surgery-consultation/' ) ); ?>" class="consultation-cta-btn d-inline-block text-center text-decoration-none" aria-label="Schedule free virtual consultation">
