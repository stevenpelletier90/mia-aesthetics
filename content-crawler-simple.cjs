...
const PROCEDURE_URLS = {
  "breast-augmentation":
    "https://www.miaaesthetics.com/cosmetic-plastic-surgery/breast/augmentation-implants/",
  ...
  "breast-implant-revision":
    "https://www.miaaesthetics.com/cosmetic-plastic-surgery/breast/implant-revision/",
  "male-bbl": "https://www.miaaesthetics.com/cosmetic-plastic-surgery/body/male-bbl/",
  "male-liposuction":
    "https://www.miaaesthetics.com/cosmetic-plastic-surgery/body/male-liposuction/",
  "male-tummy-tuck": "https://www.miaaesthetics.com/cosmetic-plastic-surgery/body/male-tummy-tuck/",
  gynecomastia:
    "https://www.miaaesthetics.com/cosmetic-plastic-surgery/breast/male-breast-procedures/",
};
...
async function crawlAllProcedures() {
  ...
  for (const [name, url] of Object.entries(PROCEDURE_URLS)) {
    ...
    if (content) {
      ...
      console.log(
        `✓ Found ${content.headings.length} headings, ${content.paragraphs.length} paragraphs`
      );
    ...
    .then((results) => {
      ...
      Object.entries(results).forEach(([name, data]) => {
        if (data.error) {
          ...
          console.log(
            `✅ ${name}: ${data.headings?.length || 0} headings, ${data.paragraphs?.length || 0} paragraphs`
          );
        }
      });
    })
